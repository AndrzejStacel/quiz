...
public class FrontendController {
    ...
    public String helloMessage(Model model) {
        model.addAttribute("message", "BE POSITIVE!");
        return "index"; // odnośnik do hello.html
    }
    ...
    public String game(Model model) {
        ...
        model.addAttribute("currentQuestionNumber",
                ongoingGameService.getCurrentQuestionNumber());
        model.addAttribute("totalQuestionNumber",
                ongoingGameService.getTotalQuestionNumber());
        model.addAttribute("currentQuestion",
                ongoingGameService.getCurrentQuestion());
        model.addAttribute("currentQuestionAnswers",
                ongoingGameService.getCurrentQuestionAnswersInRandomOrder());
        model.addAttribute("showDifficulty",
